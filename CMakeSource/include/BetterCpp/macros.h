...
#define better_class_extends(ClassName, SuperClass) class_with_ref_ptr(ClassName) better_implements(public SuperClass)
...
#define better_template_class(ClassName, ...) better_class_extends_template(ClassName, ::NSP_BETTERCPP::Object_CRTP<ClassName<__VA_ARGS__>>, __VA_ARGS__)
